# OrangeFox Recovery para Nubia Z70 Ultra (NX733J / PQ84A01)

**OrangeFox R12.1** — Basado en TWRP, con interfaz mejorada y características adicionales.
...
| Crypto / Decrypt | ✅ Funcional (FBE v2) |
| Virtual A/B | ✅ Compatible |
| Flash Current OFRP | ❌ Deshabilitado (A/B con recovery dedicada) |
...
```bash
# Si vienes de TWRP/stock recovery:
...
| `super` | Sistema completo | Oculta (soft brick si se flashea) |
